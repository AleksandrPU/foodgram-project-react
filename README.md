...
Полный список можно посмотреть по адресу 127.0.0.1:8000/api/schema/swagger-ui/ или 127.0.0.1:8000/api/schema/redoc/ при включенной режиме отладки (DJANGO_DEBUG=true в файле настроек .env).
